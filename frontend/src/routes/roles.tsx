              ...
              <div className="flex flex-wrap items-center gap-2 surface-head px-5 py-3.5">
                ...
                <span className="ml-auto flex items-center gap-1">
                  <button
                    type="button"
                    onClick={() => openEdit(r)}
                    className="h-8 rounded-lg border border-control bg-chip px-3 text-xs font-medium text-ink-muted transition-colors hover:border-primary/40 hover:text-ink"
                  >
                    {t('roles.editPerms')}
                  </button>
                  <button
