      ...
      {naming ? (
        ...
        canSave && (
          <button
            ...
            className="h-8 rounded-full border border-dashed border-control px-3 text-xs font-medium text-ink-subtle transition-colors hover:border-primary/40 hover:text-ink"
          >
